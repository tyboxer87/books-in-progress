...
AUDIO: IN: RESIDENT#1235711: Alright. This setting is pretty buried. Go into setting, privacy, go to the bottom, logging, select all logging, click save, its not in the usual space. That's cancel, they color code it to trick you. Ok click save. Confirm you want the logs off. 
